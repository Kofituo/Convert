...
open class SeparateThousands(
    ...
    private val groupingSeparator get() = Utils.groupingSeparator
    private val decimalSeparator get() = Utils.decimalSeparator
    private var lastPosition = 0
    private lateinit var prevString: CharSequence
    private val zeroDigit get() = Utils.zero
