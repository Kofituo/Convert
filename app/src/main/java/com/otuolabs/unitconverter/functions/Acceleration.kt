...
import com.otuolabs.unitconverter.constants.Acceleration
            ...
            when {
                intAssertOr(0) -> {
                    ratio = when {
                        intAssertOr(1) -> {
                            //to minutes
                            com.otuolabs.unitconverter.constants.Time.secondsToMinutes.pow(2)
                        }
                        intAssertOr(2) -> {
                            //to hours
                            com.otuolabs.unitconverter.constants.Time.secondsToHours.pow(2)
                        }
                        else -> TODO()
                    }
                }
                intAssertOr(1) -> {
                    intAssertOr(2) {
                        ratio = com.otuolabs.unitconverter.constants.Time.secondsToMinutes.pow(2)
                    }
                }
                else -> TODO()
            }
